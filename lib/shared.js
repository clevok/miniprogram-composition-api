 ...
 */
exports.setup = instance_1.overCurrentModule(function (target, callback, props, context) {
    if (props === void 0) { props = {}; }
    var binds = callback.call(target, props, context);
...
function setData(binding) {
    ...
    var stopHandels = Object.keys(binding).map(function (key) {
        ...
        _this.setData((_a = {},
            _a[key] = exports.deepToRaw(value),
            _a));
        return deepWatch(_this, key, value);
    });
    return function () {
