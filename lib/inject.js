 ...
 * @param key
 */
function useInjectAsync(key) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (key in provides) {
                // TS doesn't allow symbol as index type
                return [2 /*return*/, provides[key]];
            }
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var clearHandle = dep.depend(function (notifyKey, notifyValue) {
                        if (notifyKey === key) {
...
exports.useInjectAsync = useInjectAsync;
