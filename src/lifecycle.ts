...
function createCurrentModuleLife(
    lifecycle: ComponentLifecycle | PageLifecycle
) {
...
/** 下拉刷新 */
export const onPullDownRefresh = createCurrentModuleLife(
    PageLifecycle.ON_PULL_DOWN_REFRESH
)

/** 滚动到底部 */
export const onReachBottom = createCurrentModuleLife(
    PageLifecycle.ON_REACH_BOTTOM
)

/** 转发 */
export const onShareAppMessage = createCurrentModuleLife(
    PageLifecycle.ON_SHARE_APP_MESSAGE
)

/** 页面滚动 */
export const onPageScroll = createCurrentModuleLife(
